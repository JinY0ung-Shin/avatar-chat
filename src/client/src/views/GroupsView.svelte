  ...
  <section class="settings-card">
    <div class="panel-section-head">
      <div>
        <h3>내 그룹</h3>
        <p class="muted">
          내가 속한 그룹과 그룹원입니다. 멤버 아바타 상호 공개가 켜진 그룹에서는 그룹원끼리 자동으로 서로 신뢰해 아바타에 권한이 부여됩니다. 그룹 관리자는
    ...
    <section class="settings-card">
      <div class="panel-section-head">
        <div>
          <h3>그룹 관리</h3>
          <p class="muted">
            시스템 관리자 전용입니다. 그룹 생성·삭제와 도구 정책, 그룹원 구성을 여기서 관리합니다. 각 그룹의 공용 지식 저장소·그룹 에이전트·멤버 아바타
